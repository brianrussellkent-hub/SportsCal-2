...
const uciOneDayEvents2026: SportsEvent[] = [
  ...
  ["2026-08-30", "Bretagne Classic", "France"],
...
const uciStageRaces2026: SportsEvent[] = [
  ...
  ...createStageRaceStages({ raceIdPrefix: "catalunya-2026", raceName: "Volta a Catalunya", location: "Spain", firstStageDateIso: "2026-03-23", stageCount: 7 }),
  ...createStageRaceStages({ raceIdPrefix: "itzulia-2026", raceName: "Itzulia Basque Country", location: "Spain", firstStageDateIso: "2026-04-06", stageCount: 6 }),
  ...createStageRaceStages({ raceIdPrefix: "romandie-2026", raceName: "Tour de Romandie", location: "Switzerland", firstStageDateIso: "2026-04-28", stageCount: 6 }),
  ...createStageRaceStages({ raceIdPrefix: "giro-2026", raceName: "Giro d'Italia", location: "Italy", firstStageDateIso: "2026-05-08", stageCount: 21, restAfterStages: [3, 15] }),
